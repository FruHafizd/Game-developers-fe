            ...
            <div class="row justify-content-center ">
              ...
              >
                <div class="card-body">
                  <div class="row">
                    <div class="col-4">
                      <img :src="`http://localhost:8000/storage/${game.thumbnail}`" :alt="`${game.title} Logo`" style="width: 100%">
                    </div>
                    <div class="col">
                ...
                <router-link to="/discover-games" class="btn btn-danger w-100">Back</router-link>
